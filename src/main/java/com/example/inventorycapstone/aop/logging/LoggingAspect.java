package com.example.inventorycapstone.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut(
        """
        within(com.example.inventorycapstone.repository..*)
        || within(com.example.inventorycapstone.service..*)
        || within(com.example.inventorycapstone.web.rest..*)
        """
    )
